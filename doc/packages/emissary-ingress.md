...
| emissary-ingress.authServices[`{i}`].name                          | string |                                                                            | Auth service name                                                |
| emissary-ingress.authServices[`{i}`].url                           | string |                                                                            | Auth service URL                                                 |
| emissary-ingress.authServices[`{i}`].prefix                        | string |                                                                            | Auth service URL path prefix                                     |
| emissary-ingress.authServices[`{i}`].proto                         | string | http                                                                       | Auth service protocol: `http` or `grpc`                          |
| emissary-ingress.authServices[`{i}`].allowed_request_headers       | list   | []                                                                         | Client request headers to send to the auth service               |
| emissary-ingress.authServices[`{i}`].allowed_authorization_headers | list   | []                                                                         | Auth service response headers to add to the upstream request     |
...
| emissary-ingress.hosts[`{i}`].tls.client.caCert_b64                | string |                                                                            | Client CA certificate, in base64 without line wrapping           |
